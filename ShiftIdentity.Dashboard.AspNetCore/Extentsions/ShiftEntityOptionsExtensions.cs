...
public static class ShiftEntityOptionsExtensions
{
    ...
    /// <summary>
    /// Registers the ShiftIdentity.Core assembly as a data assembly, so the host's
    ...
    /// The DI half is wired for you inside <c>AddShiftIdentityDashboard(...)</c>.
    /// </summary>
    public static ShiftEntityOptions AddShiftIdentityDataAssembly(this ShiftEntityOptions shiftEntityOptions)
    {
        shiftEntityOptions.AddDataAssembly(typeof(Core.ShiftIdentityActions).Assembly);
